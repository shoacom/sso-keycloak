...
public class EmbeddedKeycloakApplication extends KeycloakApplication {
    ...
    static KeycloakCustomProperties keycloakCustomProperties;

    @Override
    protected void loadConfig() {
        JsonConfigProviderFactory factory = new RegularJsonConfigProviderFactory(keycloakCustomProperties);
